                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="col-sm-12">
                                    <h3 class="card-title">Manage All Executive</h3>
                                    <h3 class="card-title float-right"><a href="{{route('executive-index')}}" class="btn btn-sm btn-success">Add New</a></h3>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <table id="datatableid" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="sorting sorting_asc"rowspan="1" colspan="1">Designation</th>
                                                ...
                                                @foreach($executives as $executive)
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td><img src="{{asset($executive->image)}}"style="height: 50px" alt=""></td>
                                                        <td>
                                                            <a href="#" class="btn btn-sm btn-primary" title="View Details"><i class="fa fa-eye"></i></a>
                                                            <a href="{{route('executive-edit',['id' => $executive->id])}}" class="btn btn-sm btn-warning" title="Edit Details"><i class="fa fa-edit"></i></a>
                                                            <a href="{{route('executive-delete',['id' => $executive->id])}}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure to delete this item?')" title="Delete"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
