                    ...
                    <div class="col-md-8 offset-2">
                        ...
                        <div class="card card-info mt-3">
                            <div class="card-header">
                                <h3 class="card-title">Crate Executive List</h3>
                            ...
                            <form class="form-horizontal" method="post" action="{{route('executive-create')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    @if($errors->any())
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="designation" class="form-control" id="Title" placeholder="Enter your designation">
                                            </div>
                                        </div>
                                    <div class="form-group row">
